...
SELECTORS = MappingProxyType(
    {
        ...
        "button_excel_subject_score_input": "//button[contains(@class, 'dropdown-toggle') and contains(normalize-space(.), 'Nhập điểm từ excel')]",
        "button_class_excel_subject_score_input": "//a[@id='ContentPlaceHolder1_ctl00_lkbtImportExcelTheoLopVaMon' and contains(normalize-space(.), 'Nhập theo lớp và môn học')]",
